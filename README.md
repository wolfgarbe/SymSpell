...
1. Add **[SymSpell.cs](https://github.com/wolfgarbe/SymSpell/blob/master/symspell/SymSpell.cs), [EditDistance.cs](https://github.com/wolfgarbe/SymSpell/blob/master/symspell/EditDistance.cs) and [frequency_dictionary_en_82_765.txt](https://github.com/wolfgarbe/SymSpell/blob/master/symspell/frequency_dictionary_en_82_765.txt)** to your project. All three files are located in the SymSpell folder. Enabling the compiler option **"Prefer 32-bit"** will significantly **reduce the size** of the precalculated dictionary.
